package rechoraccoon.trackpanda
...
class OscForegroundService : Service() {
    ...
    private fun createNotificationChannel() {
        val ch = NotificationChannel("osc_raccoon_service", "Track Panda Service", NotificationManager.IMPORTANCE_LOW)
        (getSystemService(NOTIFICATION_SERVICE) as NotificationManager).createNotificationChannel(ch)
    }

    private fun buildNotification(): Notification =
        Notification.Builder(this, "osc_raccoon_service")
            .setContentTitle("Track Panda Running")
    ...
    private fun acquireWakeLock() {
        wakeLock = (getSystemService(POWER_SERVICE) as PowerManager)
            .newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "TrackPanda::WakeLock")
